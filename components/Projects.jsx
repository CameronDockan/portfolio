        ...
        <>
            <section ref={pRef} className={TIC ? "p_section counter_section visible" : "p_section counter_section invisible"}>
                ...
                <li className="project_container">
                    <a className='project_link' href="https://shreddepot-6t3fq82jn-camerondockan.vercel.app/" target="_blank"></a>
                ...
                <li className="project_container">
                    <a className='project_link' href='https://meri-bon-project.vercel.app/' target="_blank"></a>
                    <div className="p_icon_container">
                        <svg width="48" height="39" viewBox="0 0 48 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.5 38H42.5C44.7091 38 46.5 36.2091 46.5 34V10.5C46.5 8.29086 44.7091 6.5 42.5 6.5H20.7695C19.6425 6.5 18.5678 6.02459 17.8097 5.19069L15.1903 2.30931C14.4322 1.47541 13.3575 1 12.2305 1H5.5C3.29086 1 1.5 2.79086 1.5 5V34C1.5 36.2091 3.29086 38 5.5 38Z" stroke="#BEA5A9" strokeWidth="2"/>
                        </svg>
                ...
                <li className="project_container">
                    <a className='project_link' href='https://camerondockan.github.io/maybo-s_project/' target="blank"></a>
                    <div className="p_icon_container">
                        <svg width="48" height="39" viewBox="0 0 48 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.5 38H42.5C44.7091 38 46.5 36.2091 46.5 34V10.5C46.5 8.29086 44.7091 6.5 42.5 6.5H20.7695C19.6425 6.5 18.5678 6.02459 17.8097 5.19069L15.1903 2.30931C14.4322 1.47541 13.3575 1 12.2305 1H5.5C3.29086 1 1.5 2.79086 1.5 5V34C1.5 36.2091 3.29086 38 5.5 38Z" stroke="#BEA5A9" strokeWidth="2"/>
                        </svg>
                    ...
                    <br />
                    <h1 className="project_name">CrossFaded Hair Studio Website</h1>
                    <br />
                    <p className="project_description">
                        Professional business website, 
                        with 4 custom HTML5 Canvas Animations, 
                        custom virtual scroll button widget (found on the merchandice page), 
                        video content, etc.
                    </p>
                    <br />
                    <ul className="tech_ul">
